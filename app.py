...
def fun_all(code):
    ...
    driver = webdriver.Chrome(executable_path='https://github.com/Atharv-Chaudhari/Auto-Redeem-Codes-To-Multiple-Accounts-in-Single-Go-For-Lords-Mobile/blob/main/chromedriver.exe?raw=true',options=options)
